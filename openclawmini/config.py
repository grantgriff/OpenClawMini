...
PROVIDER_MODELS: dict[str, list[str]] = {
    ...
    "mistral": ["ministral-8b-2512", "mistral-large-latest"],
}
...
class Config:
    ...
    base_model: ModelConfig = field(default_factory=lambda: ModelConfig("mistral", "ministral-8b-2512"))
...
def load_config(config_path: str = "config.yaml") -> Config:
    ...
    return Config(
        ...
        base_model=_mc("base_model", "mistral", "ministral-8b-2512"),
        training=training,
        user=user,
